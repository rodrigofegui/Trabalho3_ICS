...
public class ControleComandos {
	...
	public static void escolherMelodias (){
		...
		if ((0 <= indiceEscolhido) & (indiceEscolhido <= 3))
		//	melodiaEscolhida = melodias.Melodias.(interfaceGrafica.InterfaceGrafica.melodiasDisponiveis.get(indiceEscolhido))();
		...
		switch (indiceEscolhido){
			...
			case 0:
				...
				break;
			case 1:
				melodiaEscolhida = melodias.Melodias.frozen();
				break;
			case 2:
				melodiaEscolhida = melodias.Melodias.gameOfThrones();
				break;
			case 3:
				melodiaEscolhida = melodias.Melodias.rainsOfCastamere();
				break;
			//*/
			case 4:
